...
# Check for optional inode count
if [ $# -gt 4 ]; then
    if [ $4 -gt 0 ]; then
        INODE_OPT="-i $5"
    fi
...
# Check for optional SELinux context
if [ $# -gt 5 ]; then
    SELINUX_CONTEXT="-o $6"
fi
